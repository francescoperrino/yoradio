...
<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=0.25"><meta charset="UTF-8"><link rel="icon" href="data:;base64,iVBORw0KGgo="><title>yoRadio - WEB Board Uploader</title><style>body{background-color:#000;color:#e3d25f;font-size:20px;}
...
<section>
<h2>yoRadio - WEB Board Uploader</h2>
<hr />
<span>Seleziona <u>TUTTI</u> i file in <i>yoRadio/data/www/</i><br />e caricali usando il form in basso</span>
<hr />
<form action="/%ACTION%" method="post" enctype="multipart/form-data">
<p><label for="www">www:</label> <input type="file" name="www" id="www" multiple></p>
<hr />
<span>-= OPZIONALE =-<br />Poi anche caricare <i>playlist.csv</i><br />e <i>wifi.csv file</i> dal tuo backup</span>
<p><label for="data">wifi:</label><input type="file" name="data" id="data" multiple></p>
<hr />
<p><input type="submit" name="submit" value="Carica File"></p>
</form>
<div style="padding:10px 0 0;"%UPLOADWIFI%>
<hr />
<form action="/%ACTION%" method="post" enctype="multipart/form-data">
<span>-= OPZIONALE =-<br />Se non riesci a connetterti dal tuo PC all'inidrizzo 192.168.4.1 <br />configura prima la connessione WiFi</span>
...
<p><input type="submit" name="submit" value="Salva Credenziali"></p>
</form>
</div>
</section>
</body></html>
